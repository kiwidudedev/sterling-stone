    ...
    <section className="relative min-h-screen w-full overflow-hidden bg-black bg-[url('/hero.jpg')] bg-cover bg-no-repeat bg-[position:50%_60%]">
      ...
      <div className="absolute inset-0 z-10 -translate-y-[47px]">
        <div className={`${bebas.className} absolute inset-0`}>
          ...
          <div className="absolute right-4 sm:right-8 md:right-10 lg:right-[284px] top-[calc(8rem+105px)] sm:top-[calc(9rem+105px)] lg:top-[calc(10rem+105px)] max-w-[calc(100vw-1rem)] sm:max-w-[calc(100vw-2rem)] lg:max-w-none text-white drop-shadow-[0_6px_18px_rgba(0,0,0,0.6)] lg:text-right lg:w-max">
